//#region node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-bundler-friendly.mjs
var sqlite3InitModule = (() => {
	...
	return function(moduleArg = {}) {
		...
		function findWasmBinary() {
			...
			return new URL("../../@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3.wasm", import.meta.url).href;
		}
		var wasmBinaryFile;
		...
		Module.runSQLite3PostLoadInit = function(EmscriptenModule) {
			...
			globalThis.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
				...
				const flexibleString = function(v) {
					if (isSQLableTypedArray(v)) return typedArrayToString(v instanceof ArrayBuffer ? new Uint8Array(v) : v);
			...
			globalThis.Jaccwabyt = function StructBinderFactory(config) {
				...
				const makeMemberWrapper = function f(ctor, name, descr) {
					...
					else prop.set = function(v) {
						if (dbg.setter) log("debug.setter:", f._.setters[sigGlyph], "for", sigIR(sigGlyph), xPropName, "@", this.pointer, "+", descr.offset, "sz", descr.sizeof, v);
				...
				const StructBinder = function StructBinder(structName, structInfo) {
					...
					const StructCtor = function StructCtor(externalMemory) {
						...
						} else __allocStruct(StructCtor, this);
					};
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
				...
				delete globalThis.Jaccwabyt;
				{
					...
					} else util.sqlite3__wasm_db_error = function(pDb, errCode, msg) {
				...
				}
				{
					...
					capi.sqlite3_prepare_v3 = function f(pDb, sql, sqlLen, prepFlags, ppStmt, pzTail) {
						...
						switch (typeof xSql) {
							...
							default: return util.sqlite3__wasm_db_error(pDb, capi.SQLITE_MISUSE, "Invalid SQL argument type for sqlite3_prepare_v2/v3().");
						}
					};
				...
				const installMethod = function callee(tgt, name, func, applyArgcCheck = callee.installMethodArgcCheck) {
					...
					else if (!(func instanceof Function) && !wasm.isPtr(func)) toss("Usage errror: expecting a Function or WASM pointer to one.");
			...
			globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
				const installOpfsVfs = function callee(options) {
					...
					return new Promise(function(promiseResolve_, promiseReject_) {
						...
						const W = new Worker(new URL("../../@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-opfs-async-proxy.js", import.meta.url));
						setTimeout(() => {
...
//#endregion
//#region node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-worker1-promiser.mjs
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
	worker: function() {
		return new Worker(new URL("../../@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-worker1-bundler-friendly.mjs", import.meta.url), { type: "module" });
	},
...
//#endregion
//#region node_modules/@sqlite.org/sqlite-wasm/index.mjs
var sqlite3Worker1Promiser$1 = globalThis.sqlite3Worker1Promiser;
var sqlite_wasm_default = sqlite3_bundler_friendly_default;
//#endregion
export { sqlite_wasm_default as default, sqlite3Worker1Promiser$1 as sqlite3Worker1Promiser };
